...
public class FontGenerator {
    ...
    Label.LabelStyle labelStyle72 = new Label.LabelStyle(generateFont("fonts/GoodDog.otf", 72), Color.WHITE);
    Label.LabelStyle labelStyle72Yellow = new Label.LabelStyle(generateFont("fonts/GoodDog.otf", 72), Color.YELLOW);
